...
# Region
## basque
    - axoa (émincé de veau au piment, oignon, ail)
    - piperade (sorte chakchouka)
...
## Roumanie
    * tochitura (polenta, boeuf et poulet, sauce tomate, servi avec caillé de lait)
    * mititei ou mici : saucisse grasse + ail, poivre, thym, sarriette, coriandre
...
# biscuit
- canestrelli (italie) : biscuit sec
- polvoron almenda (espagne) : biscuit à l'amande qui s'effrite 
